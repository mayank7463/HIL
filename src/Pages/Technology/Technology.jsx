            ...
            <div>
                  <p className='text-2xl font-bold py-4'>Technology and Digitalisation</p>
                    ...
                    <div className='grid lg:grid-cols-5 sm:grid-cols-1 my-8 space-x-4'>
                        ...
                        <div>
                            <img src="./Technology/tech-6.jpg" alt="" />
                        </div>
                        <div className=''>
                            <img src="./Technology/tech-7.jpg" alt="" />
                        </div>
                        <div>
                            <img src="./Technology/tech-8.jpg" alt="" />
                        </div>
                        <div className=''>
                            <img src="./Technology/tech-9.jpg" alt="" />
                        </div>
                    </div>
                    <div>
                        <p className='text-xl font-bold py-4'>Key Initiatives</p>
                        <div className='grid lg:grid-cols-5 sm:grid-cols-1 gap-4'>
                            <div>
                                <img src="./Technology/tech-10.jpg" alt="" />
                            </div>
                            <div>
                                <img src="./Technology/tech-11.jpg" alt="" />
                            </div>
                            <div>
                                <img src="./Technology/tech-12.jpg" alt="" />
                            </div>
                            <div>
                                <img src="./Technology/tech-13.jpg" alt="" />
                            </div>
                            <div>
                                <img src="./Technology/tech-14.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                    <div>
                        <img src="./Technology/tech-15.jpg" alt="" />
                    </div>
